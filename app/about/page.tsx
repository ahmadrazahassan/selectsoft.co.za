...
export const metadata: Metadata = { title: "About the publication" };

export default function AboutPage() {
  return <InfoPage eyebrow="About us" title="A calmer way to choose software." intro="Software Select ZA is an independent editorial publication for South African businesses. We turn complicated product information into a decision a working team can understand." sections={[
